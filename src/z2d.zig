...
//! composed off of vector primitives: lines and cubic Beziers, e.g., things
//! you would need if you were rendering something like an SVG file, or
//! rendering shapes directly for UI elements. It also provides a (growing) API
//! for image manipulation, which mainly supports our vector rasterization
//! features, but can also be worked with directly at the lower level.
//!
